/**!
 * xml2json service wrapped into module usable by angularjs so as to not pollute global scope
 * @author  Sammy  <sammychl@hotmail.com>
 * @author  Fabio  <fabiocanada@yahoo.ca>
 * @version 0.0.2
 *
 * wrapper is at very bottom
 *
 */


/************************
 * available methods on xml2json:
 * parser
 * xml_to_object
 * show_json_structure
 * no_fast_endings
...
(function () {
    ...
    angular.module("angularXml2json", []).factory("ngXml2json", function () {
        return xml2json;
    })
